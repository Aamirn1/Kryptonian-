                ...
                <main ref={containerRef} className="relative z-10 pt-40 pb-32 px-6">
                    <div className="container mx-auto max-w-7xl">
                        ...
                        <div className="partner-header text-center mb-24 max-w-4xl mx-auto">
                            ...
                            <Link
                                href="#apply"
                                className="group relative overflow-hidden inline-flex items-center gap-3 px-8 py-4 btn-gradient hover:btn-gradient-hover text-white font-semibold rounded-full transition-[color,background-color,border-color,box-shadow,transform,opacity] active:scale-95"
                            >
                        ...
                        <div className="partner-content mb-32 p-12 bg-electric/5 border border-electric/20 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-[0_10px_40px_-15px_rgba(202, 109, 229,0.2)]">
                            ...
                            <button className="group relative overflow-hidden z-10 inline-flex items-center gap-3 px-8 py-5 btn-gradient hover:btn-gradient-hover text-white font-semibold rounded-full transition-[color,background-color,border-color,box-shadow,transform,opacity]">
                                <span className="shimmer-sweep" />
                        ...
                        <div id="apply" className="partner-content max-w-4xl mx-auto">
                            <div className="bg-white border border-black/10 rounded-3xl p-12 md:p-20 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.12)]">
                                ...
                                <form className="space-y-8">
                                    ...
                                    <button className="group relative overflow-hidden w-full py-5 btn-gradient hover:btn-gradient-hover text-white font-semibold rounded-full transition-[color,background-color,border-color,box-shadow,transform,opacity] active:scale-95 flex items-center justify-center gap-3 shadow-xl shadow-electric/10 uppercase tracking-[0.12em] text-xs">
                                        <span className="shimmer-sweep" />
