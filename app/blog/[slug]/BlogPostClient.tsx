      ...
      >
        ...
        <main>
          ...
          <section className="pt-40 pb-20 px-6">
            <div className="container mx-auto max-w-4xl">
              <div className="post-header">
                ...
                {/* Author */}
                <div className="flex items-center gap-4 pb-8 border-b border-zinc-200">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-sm">{post.authorRole}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="post-content">
                  ...
                  <div className="flex flex-wrap gap-2 mt-12 pt-8 border-t border-zinc-200">
                    {post.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-4 py-2 bg-zinc-100 text-zinc-600 text-sm font-medium rounded-full"
                      >
                  ...
                  <div className="sticky top-32 space-y-8">
                    ...
                    <div className="p-6 bg-foreground rounded-2xl">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-white/10 border border-white/10 rounded-xl text-white placeholder:text-zinc-500 text-sm mb-3 focus:outline-none focus:border-primary"
                      />
                      <button className="w-full py-3 bg-primary text-white font-bold rounded-full hover:bg-primary/80 transition-colors text-sm">
                        Subscribe
                      </button>
                    </div>
                      ...
                      <div className="space-y-2">
                        {Array.from(
                          ...
                          <Link
                            ...
                            className="flex items-center justify-between py-2 text-zinc-600 hover:text-primary transition-colors"
                          >
                            <span>{category}</span>
          ...
          {relatedPosts.length > 0 && (
            <section className="related-section py-20 px-6 bg-white border-y border-zinc-200">
