    ...
    <SmoothScroll>
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden -z-10">
          <div className="absolute top-[5%] left-[-10%] w-[50vw] h-[50vw] bg-electric/5 rounded-full blur-[150px] animate-pulse" />
          <div className="absolute bottom-[20%] right-[-5%] w-[40vw] h-[40vw] bg-violet/5 rounded-full blur-[120px]" />
        </div>
