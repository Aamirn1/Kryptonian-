            ...
            <div className="container mx-auto max-w-4xl">
              <div className="space-y-8">
                {sections.map((section, index) => (
                  <div
                    key={index}
                    className="policy-section p-8 md:p-12 bg-white border border-black/10 rounded-3xl shadow-[0_10px_40px_-15px_rgba(0,0,0,0.12)] hover:border-electric/30 transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-300"
                  >
