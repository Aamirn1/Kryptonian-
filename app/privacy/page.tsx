    ...
    <SmoothScroll>
      ...
      >
        ...
        <main className="pt-32 pb-32">
          {/* Hero Section */}
          <section className="privacy-hero px-6 mb-20">
          ...
          <section className="px-6 mb-16">
            <div className="container mx-auto max-w-4xl">
              <div className="p-8 md:p-12 bg-white border border-[#cb6ce6]/40 rounded-4xl shadow-lg shadow-zinc-200/20">
            ...
            <div className="container mx-auto max-w-4xl">
              <div className="space-y-12">
                {sections.map((section, index) => (
                  <div
                    key={index}
                    className="policy-section p-8 md:p-12 bg-white border border-[#cb6ce6]/40 rounded-4xl shadow-sm hover:shadow-lg hover:shadow-zinc-200/20 transition-shadow"
                  >
