...
export default function Testimonials() {
  ...
  return (
    ...
    >
        ...
        >
          {testimonials.map((testimonial) => (
            <div
              ...
              className="testimonial-card-horizontal group shrink-0 w-[85vw] md:w-[45vw] lg:w-[30vw] p-8 bg-white border border-zinc-200 rounded-[2.5rem] shadow-lg shadow-zinc-200/20 hover:shadow-xl hover:shadow-zinc-200/30 hover:border-primary/20 transition-all cursor-pointer"
            >
      ...
      {/* Trust Indicators */}
      <div className="mt-20 pt-16 border-t border-zinc-200 px-6">
