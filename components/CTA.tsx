            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <Link
                            href="/pricing"
                            className="shine-btn group relative inline-flex items-center gap-4 px-10 py-5 bg-foreground text-white font-bold rounded-full overflow-hidden transition-all hover:bg-[#cb6ce6] active:scale-95 mx-auto"
                        >
