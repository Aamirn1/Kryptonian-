        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col text-left mx-8 lg:mx-0">
            ...
            <div ref={ctaRef} className="flex flex-row gap-2 sm:gap-4">
              <Link
                href="/pricing"
                className="group relative px-4 sm:px-5 py-5 bg-foreground text-white font-bold rounded-full transition-all hover:bg-primary active:scale-95 flex flex-1 sm:w-[220px] sm:flex-none items-center gap-2 justify-center whitespace-nowrap"
              >
          ...
          >
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              {/* Floating icon stat cards (replaces old Tag-1/Tag-2 text PNGs) */}
