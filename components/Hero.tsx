        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col text-left mx-8 lg:mx-0">
            ...
            <div ref={ctaRef} className="flex flex-row gap-2 sm:gap-4">
              <Link
                href="/pricing"
                className="group relative px-4 sm:px-5 py-2.5 bg-foreground text-white font-bold rounded-full transition-all hover:bg-primary active:scale-95 flex items-center gap-2 flex-1 justify-center whitespace-nowrap"
              >
              ...
              <Link
                href="/services"
                className="px-4 sm:px-5 py-2.5 rounded-full border border-foreground/15 md:border-[#cb6ce6] text-foreground/80 hover:bg-[#cb6ce6] hover:text-white hover:border-[#cb6ce6] font-bold transition-all active:scale-95 flex items-center justify-center gap-2 flex-1 whitespace-nowrap"
              >
                <span className="uppercase tracking-widest text-xs sm:text-medium">
                  Services
                </span>
