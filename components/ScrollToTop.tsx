...
export default function ScrollToTop() {
  ...
  return (
    <button
      ...
      className={cn(
        "fixed bottom-6 left-6 z-[90] flex h-12 w-12 items-center justify-center rounded-full border border-[#281000]/20 bg-white/80 backdrop-blur-xl text-zinc-700 shadow-[0_8px_30px_-8px_rgba(0,0,0,0.15)] transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-300 hover:border-primary/50 hover:text-primary hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",
        visible
